...
internal class SynkAdapterProcessorTest {
    ...
    fun `compilation succeeds when target implement IDResolver interface`() {
        ...
        assertSourceEquals(
            """
                ...
                import com.test.processor.db.FooMapEncoder
        ...
        assertSourceEquals(
            """
                ...
                public class BarMapEncoder : MapEncoder<Foo.Bar> {
                    override fun encode(crdt: Foo.Bar): Map<String, String> {
                        val map = mutableMapOf<String, String>()
                        map["bar"] = crdt.bar
                    ...
                    override fun decode(map: Map<String, String>): Foo.Bar {
                        val crdt = Foo.Bar(
                            map["bar"]!!,
                            map["baz"]!!.toInt(),
                            map["bim"]!!.toBoolean(),
        ...
        assertSourceEquals(
            """
                ...
                public class BazMapEncoder : MapEncoder<Foo.Baz> {
                    override fun encode(crdt: Foo.Baz): Map<String, String> {
                        val map = mutableMapOf<String, String>()
                        map["bing"] = crdt.bing
                        map["bam"] = crdt.bam
                        return map
                    ...
                    override fun decode(map: Map<String, String>): Foo.Baz {
                        val crdt = Foo.Baz(
                            map["bing"]!!,
                            map["bam"]!!,
                        )
        ...
        assertSourceEquals(
            """
                ...
                public class BarMapEncoder(
                    private val bimMapEncoder: MapEncoder<Bim?> = NullableMapEncoder(BimMapEncoder()),
                ) : MapEncoder<Bar> {
                    override fun encode(crdt: Bar): Map<String, String> {
                        val map = mutableMapOf<String, String>()
                        map["second"] = crdt.second
                        return map + bimMapEncoder.encode(crdt.bim)
                    }

                    override fun decode(map: Map<String, String>): Bar {
                        val crdt = Bar(
        ...
        assertSourceEquals(
            """
                ...
                public class BimMapEncoder : MapEncoder<Bim> {
                    override fun encode(crdt: Bim): Map<String, String> {
                        val map = mutableMapOf<String, String>()
                    ...
                    override fun decode(map: Map<String, String>): Bim {
                        val crdt = Bim(
                            map["first"]!!,
                            map["second"]!!,
                        )
    ...
    @Test
    fun `compilation succeeds when target has a serializable generic property`() {
        val compilationResult = compile(BAR_VALUE_CLASS_GENERIC, BAR_VALUE_CLASS_GENERIC_SERIALIZER, BAZ_ENUM_CLASS, FOO_VALUE_CLASS_GENERIC, FOO_RESOLVER)
        println(compilationResult.sourceFor("FooMapEncoder.kt"))
        ...
        assertSourceEquals(
            ...
            public class FooMapEncoder(
                private val barSerializer: BarSerializer<String> = BarSerializer<String>(),
                private val barNullSerializer: BarSerializer<String> = BarSerializer<String>(),
                private val bazSerializer: EnumStringSerializer<Baz> = EnumStringSerializer<Baz>(),
            ) : MapEncoder<Foo> {
                override fun encode(crdt: Foo): Map<String, String> {
                    val map = mutableMapOf<String, String>()
